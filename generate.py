...
<head>
	...
	<style>
		*, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
		...
		.vocab-toggle:hover {{ background: #efe9df; }}
		.vocab-grid {{
			display: none;
		...
		.vocab-card:hover {{ box-shadow: 0 2px 8px rgba(0,0,0,0.08); }}
		.vocab-word {{
			font-weight: 600;
			display: block;
			margin-bottom: 4px;
		...
		.badge-highfreq {{ background: #dbeafe; color: #1e40af; }}
		.badge-term {{ background: #fde8cc; color: #9a4e00; }}
		.vocab-ipa {{
			display: block;
			font-size: 12px;
			color: #8a7e6e;
		...
		h2.para-original, h3.para-original {{
			font-size: 20px;
			margin-bottom: 4px;
		}}
		.para-translation {{
		...
		h2.para-translation, h3.para-translation {{
			font-size: 16px;
			font-weight: 400;
		}}
		...
		.word-highfreq:hover {{ background: #dbeafe; border-radius: 2px; }}
		.word-term:hover {{ background: #fde8cc; border-radius: 2px; }}
		...
		.btn-speak:hover {{ background: #4a4035; }}
		.btn-known {{
			background: #e8f5e9;
			color: #2e7d32;
		...
		.btn-known.marked {{ background: #2e7d32; color: #fff; }}
		.btn-close {{
			position: absolute;
			top: 12px;
			right: 14px;
